...
export default function HelpSplitScreen() {
  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: C.cream }]}>
      <View style={[styles.header, { borderBottomColor: C.lightBorder }]}>
        ...
        <Text style={[styles.title, { color: C.darkSlate }]}>{t('helpSplit.title')}</Text>
        <View style={styles.backBtn} />
      </View>

      <ScrollView contentContainerStyle={styles.body} showsVerticalScrollIndicator={false}>
        <Text style={[styles.intro, { color: C.sage }]}>{t('helpSplit.intro')}</Text>
